...
- 台账：桌面悬浮记录器开始/暂停/停止计时，浏览器后台按今天/昨天/日历查看，最近记录优先展示
- 悬浮记录器：独立 recorder 横向小秒表，窄标签下拉 + HH:MM:SS + 开始/暂停合一 + 停止；5 秒无操作自动收缩为时间胶囊，鼠标移入恢复
- 快捷键：F8 开始/暂停，F9 停止，F10 截图；面板从托盘打开，避开系统热键冲突
- 暂停点：任务进行中可随手打 marker，后台可为暂停点改标签，并按暂停点拆分/合并台账记录
- 待办：浏览器完整管理状态/优先级/截止时间/重开/过期过滤，桌面到期提醒，Agent MCP 工具写入/查询/更新/完成/重开/删除
